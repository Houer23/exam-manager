...
def _frame() -> pd.DataFrame:
    return pd.DataFrame(
        [
            _HEADER,
            [
                "示例一中", "990001", "250907010001", "331123200101010101", "张三",
                "李老师", 2501.0, 87.0, 44.0, 43.0, 98.63, 0.0, 8.0, 1.0,
                2.0, "C", 0.0, "A", 2.0, "B",
                3.0, 6.0, 6.0, 2.0,
            ],
            [
                "示例一中", "990001", "250907010002", "331123200101010102", "李四",
                "王老师", 2516.0, 79.0, 44.0, 35.0, 93.29, 0.0, 190.0, 5.0,
                2.0, "C", 2.0, "A", 0.0, "B",
                3.0, 4.0, 4.0, 2.0,
            ],
        ]
...
def test_parse_export_frame():
    ...
    assert score["school"].tolist() == ["示例一中", "示例一中"]
    # 选择项/知识点列不入小题明细
    ...
    # 得分正确
    s1 = questions[questions["student_id"] == "250907010001"]
...
def test_parse_invalid_rows_filtered():
    frame = _frame()
    frame.loc[len(frame)] = [
        "示例一中", "990001", "bad-id", "x", "无效", "李老师", 2501.0,
