...
dpi: 150
figure_width: 14           # 画布宽度
row_height: 0.55           # 每班行高（画布高度 = max(min_figure_height, 行数×row_height)）
...
colors:
  ...
  metrics:
    ...
    平均数: {color: tab:green, marker: D}
    Q3: {color: tab:red, marker: ^}
...
annotations:
  ...
  text_y_offset: 0.58      # M/Q1/Q3 相对行中心的 y 偏移
